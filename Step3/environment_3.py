...
class Environment:
    def __init__(self, class_id):
        ...
        self.pricing_probabilities = param.pricing_probabilities[self.class_id]
        ...
        self.cum_costs = param.cumulative_cost_per_bid_functions[self.class_id](param.bids)
    ...
    def round(self, pulled_bids_arm, pulled_prices_arm):
        ...
        n_clicks = np.round(max(0, param.n_clicks_per_bid_functions[self.class_id](bid) + np.random.normal(0,
                                                                                                  param.n_clicks_per_bid_sigma))).astype(np.int32)
