...
class UCBOptimizer:
    def __init__(self, learner_type, class_id, learner_parameters):
        ...
        self.n_clicks = np.round(param.n_clicks_per_bid_by_class[class_id](param.bids)).astype(np.int32)
        self.cum_costs = param.cum_cost_per_bid_by_class[class_id](param.bids)
